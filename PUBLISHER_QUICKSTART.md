...
External application, service, CLI, connector, and protocol-adapter developers should start with:
...
外部application、service、CLI、connector、およびprotocol adapterの開発者は、次の文書から始めてください。
