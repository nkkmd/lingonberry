...
**Status: v0.5.0 release candidate in review** | **Last updated: 2026-07-19**

この文書は、Lingonberryの実装作業を中断・再開するときの引き継ぎ用正本です。

## 1. Release state

v0.5.0の機能実装、end-to-end smoke scenario、package version更新、release checklist、release notesをPR #94で最終確認しています。
...
publication state: tag and GitHub Release pending merge and main-CI confirmation
```
...
| workspace package version 0.5.0 | release candidateへ反映済み |
