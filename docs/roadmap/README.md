...
**Status: v0.5.0 active** | **Latest published release: v0.4.0** | **Last updated: 2026-07-19**
...
4. [v0.4.0 Release Checklist](./RELEASE_0_4_0_CHECKLIST.md)
5. [v0.4.0 Release Notes](./RELEASE_0_4_0_RELEASE_NOTE.md)
6. [v0.4.0 Roadmap](./RELEASE_0_4_0_ROADMAP.md)
7. [Quarantine Replacement Retention Policy](../operations/QUARANTINE_REPLACEMENT_RETENTION_POLICY.md)
8. [Cleanup Operations Runbook](../operations/QUARANTINE_REPLACEMENT_CLEANUP_RUNBOOK.md)
9. [運用文書索引](../operations/README.md)
10. [実装バックログ](./IMPLEMENTATION_BACKLOG.md)

`CURRENT_IMPLEMENTATION_STATUS.md`は中断後に作業を再開するための引き継ぎ用正本です。`ROADMAP_TO_V1_0.md`はv0.4.0以降のrelease-level roadmapです。現在の実装対象は`RELEASE_0_5_0_ROADMAP.md`を正本とします。

## v0.5.0の対象

v0.5.0では、通常のknowledge object lifecycleをend-to-endで完成させます。
...
- [v0.5.0 Release Roadmap](./RELEASE_0_5_0_ROADMAP.md): 通常object lifecycleの設計・実装・検証計画
